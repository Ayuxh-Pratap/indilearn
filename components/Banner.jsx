...
const Banner = () => {
  return (
    <section className='container px-5 bg-dark text-white text-center py-14 rounded-[1rem]'>
      ...
      <h3 className='lg:w-[40vw] w-auto leading-10 mb-8'>Join Us by Creating Account or Start a Free Trial</h3>
      ...
      <button className='btn primary mr-2'><a href="/">Lets Talk</a></button>
      <button className='btn primary ml-2'><a href="/">Lets Talk</a></button>
    </section>
  )
}
