        ...
        <section id='section'>
            <div className='container lg:px-20 px-5 bg-dark text-white text-center py-14 rounded-[1rem]'>
                ...
                <div className='flex lg:flex-row flex-col gap-20'>
                    <div data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000" className='basis-2/3 flex flex-col gap-4 text-black'>
                    ...
                    <div data-aos="fade-up" data-aos-delay="100" data-aos-duration="1000" className='basis-1/3 h-10 text-left'>
